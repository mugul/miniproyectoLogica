    ...
    <div class="navbar-inner">
      <div class="container">
        ...
        <div class="nav-collapse collapse">
          <ul class="nav">
	    <li ${guardarMenu}><a href="guardar" style="padding-right:0px" >Guardar Predicado</a></li>
            <li ${listarTerminosMenu}><a href="listar?comb=n" style="padding-right:0px">listar Predicados</a></li>
