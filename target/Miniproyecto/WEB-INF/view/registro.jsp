    ...
    <center>
        <sf:form method="POST" modelAttribute="usuario">
            <table>
                ...
                <tr><td>Login:</td><td><sf:input path="login" id="usuario_login"/><sf:errors path="login" cssClass="error" /></td></tr>
                <tr><td>Password:</td><td><sf:password path="password" showPassword="true" id="usuario_password"/></td></tr>
                <tr><td>Confirme su password:</td><td><input type="password" name="password2"></td></tr>
            </table>
            <input type="submit" value="Registrese">
        </sf:form>
            <a href="/Miniproyecto/index">Login</a>
    </center>
        </div>
    </body>
</html>
